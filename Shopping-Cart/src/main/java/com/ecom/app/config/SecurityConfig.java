    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/category/*").hasAnyAuthority("ROLE_ADMIN","ROLE_USER","ROLE_SUPER-ADMIN")
                        .requestMatchers("/user/list","/api/products","/api/products/list",
                                "/api/product/**","/api/category","/api/category/**","/api/categories").hasAnyAuthority("ROLE_ADMIN","ROLE_SUPER-ADMIN")
